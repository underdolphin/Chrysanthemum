...
fragment IdentifeirPartCharacter:
	LetterCharacter
	| DecimalDeigitCharacter
	| ConnectingCharacter
	| CombiningCharacter
	| FormattingCharacter;
/* A Unicode character of class Lu,Ll,Lt,Lm,Lo,Nl and UnicodeEscapeSequence*/
...
/* A Unicode character of class Nd and UnicodeEscapeSequence*/
fragment DecimalDeigitCharacter:
	UnicodeClassND
	| UnicodeEscapeSequence;
/* A Unicode character of class Pc and UnicodeEscapeSequence*/
fragment ConnectingCharacter:
	UnicodeClassPC
	| UnicodeEscapeSequence;
/* A Unicode character of class Mn,Mc and UnicodeEscapeSequence*/
fragment CombiningCharacter:
	UnicodeClassMN
	| UnicodeClassMC
	| UnicodeEscapeSequence;
/* A Unicode character of class CF and UnicodeEscapeSequence*/
